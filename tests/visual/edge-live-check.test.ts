...
describe('edge live check', () => {
  ...
  test('builds a proof-shell failure artifact for a 404 capture', async () => {
    ...
    const artifact = buildProofSurfaceFailureArtifact({
      ...
      runDir: 'tmp/captures/mazer-edge-live/watch-pass-preview',
      metadataPath: 'tmp/captures/mazer-edge-live/watch-pass-preview/metadata/watch-pass-ios-full-phone-portrait.failure.json',
      screenshotPath: 'tmp/captures/mazer-edge-live/watch-pass-preview/screenshots/watch-pass-ios-full-phone-portrait.failure.png'
    });
