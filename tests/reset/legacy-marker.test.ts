...
describe('Mazer completion markers', () => {
  ...
  test('keeps the level/rank/complexity progression contract tracked', () => {
    ...
    expect(markerDoc).toContain('`monotonicAverageRouteRatioPass`');
    ...
    expect(markerDoc).toContain('Recovery-target diagnostics now record candidate count and selected-score margin');
