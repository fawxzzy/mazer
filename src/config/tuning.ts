const createAmbientSkyTuning = () => ({
  ...
  driftMoteSpeedPxPerSecMax: 0.8,
  hazeLayerCount: 2,
  hazeAlphaMin: 0.05,
  hazeAlphaMax: 0.11,
  hazeDriftRangePx: 18,
  hazeDriftDurationMinMs: 52000,
  hazeDriftDurationMaxMs: 110000,
  shootingStar: {
    minIntervalMs: 18000,
    maxIntervalMs: 32000,
    durationMinMs: 900,
  ...
  ufo: {
    minIntervalMs: 150000,
    maxIntervalMs: 220000,
    durationMinMs: 3600,
    durationMaxMs: 6200,
    alphaMin: 0.16,
    alphaMax: 0.22,
...
export const legacyTuning = {
  ...
  menu: {
    ...
    intentFeed: {
      ...
      maxVisibleEntries: 3,
      minHeightPx: 84,
      compactMinHeightPx: 72,
      paddingXPx: 16,
      paddingYPx: 10,
      headerHeightPx: 18,
      compactHeaderHeightPx: 15,
      lineHeightPx: 22,
      compactLineHeightPx: 19,
      entryGapPx: 4,
      headerFontPx: 10,
      compactHeaderFontPx: 9,
      statusFontPx: 15,
      compactStatusFontPx: 13,
      entryFontPx: 14,
      compactEntryFontPx: 12,
      riskFontPx: 11,
      compactRiskFontPx: 10,
      summaryMaxChars: 42,
      compactSummaryMaxChars: 32,
      statusMaxChars: 40,
      compactStatusMaxChars: 30,
      minimumDwellMs: 2200,
      replacementDebounceMs: 920,
      transitionMs: 320,
      transitionStartAlpha: 0.6,
      occlusionPadPx: 36,
      anchorSizePx: 56,
      boardGapPx: 12,
      installGapPx: 12,
