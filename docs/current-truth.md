...
- options/features/game-modes still need more field-by-field exactness, and pause still needs broader field responsibility cleanup beyond the now-explicit command routing contract
