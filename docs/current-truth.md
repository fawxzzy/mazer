...
- pause still needs broader field responsibility cleanup beyond the now-explicit command routing contract, and nested overlay verification is still not fully closed
