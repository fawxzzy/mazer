...
- exact active-play feel beyond the keyboard/pointer/focus-loss movement adapters, pause-reset trail preservation, extracted source-exact timer/goal-arrow contract, tighter compact overlay, minimal HUD widget chrome, data-only diagnostics proof, and full proof bounds
