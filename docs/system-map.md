...
| menu trench width / connection-aware core continuity / segment-based static strokes / static edge alpha / core-vs-grid read | `src/legacy-runtime/legacyMenuRender.ts` + `src/scenes/MenuScene.ts` |
