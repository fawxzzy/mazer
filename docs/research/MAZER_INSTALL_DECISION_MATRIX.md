...
- Current install runtime: [`src/boot/installSurface.ts`](src/boot/installSurface.ts)
- Current title-plate install UX: [`src/scenes/MenuScene.ts`](src/scenes/MenuScene.ts)
- Current manifest: [`public/manifest.webmanifest`](public/manifest.webmanifest)
- Current HTML wiring: [`index.html`](index.html)
- Current PWA plugin and SW stance: [`vite.config.ts`](vite.config.ts)
- Current localhost SW cleanup: [`src/boot/main.ts`](src/boot/main.ts)
- Current Windows launcher lane: [`scripts/windows/Launch-Mazer.ps1`](scripts/windows/Launch-Mazer.ps1)
- Current Windows shortcut lane: [`scripts/windows/Prepare-MazerShortcut.ps1`](scripts/windows/Prepare-MazerShortcut.ps1)
