...
The repo-wide 1:1 marker is currently held at `71%` after the 2026-07-01 reality check and the raster bridge shortcut ratchet. Older ops receipts that mention `97%` are historical packet state, not current marker truth.
