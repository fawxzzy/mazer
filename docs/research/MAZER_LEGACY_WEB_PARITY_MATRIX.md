...
The repo-wide 1:1 marker is currently held at `78%` after the 2026-07-01 reality check, raster bridge shortcut ratchet, active runtime shortcut bridge ratchet, active runtime wall-array shortcut selection ratchet, active runtime checkpoint path-builder ratchet, fixed menu 49-cell density ratchet, and menu path-relief material ratchet. Older ops receipts that mention `97%` are historical packet state, not current marker truth.
