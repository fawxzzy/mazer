...
The repo-wide 1:1 marker is currently held at `72%` after the 2026-07-01 reality check, raster bridge shortcut ratchet, and active runtime shortcut bridge ratchet. Older ops receipts that mention `97%` are historical packet state, not current marker truth.
